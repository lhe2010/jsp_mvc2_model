...
<body>
	...
	<div align="center">
		...
		<form action="applyAction.do" method="post">
			<h4>개인 정보</h4>
			<label>이름</label> <input type="text" name="name" value="${ mdto.name }" autofocus placeholder="공백없이 입력하세요"> 
			<br>
			<label>연락처</label> <input type="text" name="tel" value="${ mdto.tel }" size="20"> 
			<br> 
